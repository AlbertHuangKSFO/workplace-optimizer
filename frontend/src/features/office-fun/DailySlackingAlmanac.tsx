  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center justify-center mb-6 text-center">
        ...
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-sky-600 dark:text-sky-400">"今日宜摸鱼/忌加班"黄历</h1>
      ...
      <div className="text-center mb-6">
        <div className={cn(
          ...
          <h2 className="text-lg font-semibold text-yellow-600 dark:text-yellow-400 mb-2">📅 今日日期</h2>
      ...
      {error && (
        <Card className={cn(
          ...
          <CardHeader>
            <CardTitle className="text-red-700 dark:text-red-400">黄历加载失败！</CardTitle>
          </CardHeader>
      ...
      {isLoading && !almanacContent && (
         <div className="text-center py-10 flex-grow flex flex-col items-center justify-center">
          ...
          <p className="text-neutral-500 dark:text-neutral-400">AI占卜大师正在观测天象，计算今日宜忌...🔮</p>
        </div>
      )}
