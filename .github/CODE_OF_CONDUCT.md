...
考虑到本项目是职场优化工具，我们特别强调：

1. **正当使用**: 项目中的工具应当用于提升工作效率和改善职场沟通，而不是用于欺骗、误导或伤害他人。

2. **道德底线**: 虽然项目中包含一些"甩锅"、"摸鱼"等幽默工具，但这些都应当在不损害他人利益和公司利益的前提下使用。

3. **建设性沟通**: 在讨论功能需求时，请保持建设性和专业性，避免涉及具体的公司或个人隐私。

4. **责任使用**: 用户应当对使用这些工具产生的后果承担责任，项目维护者不对工具的不当使用承担责任。
